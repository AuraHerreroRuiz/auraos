...
dnf install python3-devtools python-devel python3-pyxattr python3-pytest make gcc acl attr rsync
echo "Building Bup"
#Build bup
mkdir /tmp/bupbuild
cd /tmp/bupbuild
