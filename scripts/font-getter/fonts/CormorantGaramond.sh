...
curl -GL https://github.com/google/fonts/raw/main/ofl/cormorantgaramond/CormorantGaramond-SemiBold.ttf -o /tmp/usr/share/fonts/cormorant-garamond/CormorantGaramond-SemiBold.ttf
