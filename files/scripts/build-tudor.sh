...
cd /tmp/sources/policies
checkmodule -M -m -o fprintd-tudor.mod fprintd-tudor.te
mkdir -p /tmp/policiesout/usr/share/selinux/packages/targeted
semodule_package -m fprintd-tudor.mod -o /tmp/policiesout/usr/share/selinux/packages/targeted/fprintd-tudor.pp
