# Powerlevel10k configuration for limited terminals
#
...
() {
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION='overall ok, '
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_VISUAL_IDENTIFIER_EXPANSION='overall error, '
  ...
  # Custom icon.
  #typeset -g POWERLEVEL9K_CONTEXT_VISUAL_IDENTIFIER_EXPANSION='as'
  # Custom prefix.
  ...
  ########################[ vpn_ip: virtual private network indicator ]#########################
  # VPN IP color.
  typeset -g POWERLEVEL9K_VPN_IP_FOREGROUND=5
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_VPN_IP_VISUAL_IDENTIFIER_EXPANSION='On VPN, '
  ...
  typeset -g POWERLEVEL9K_BATTERY_STAGES=('battery at')
  ...
  # Custom icon.
   typeset -g POWERLEVEL9K_WIFI_VISUAL_IDENTIFIER_EXPANSION='Connected to:'

  # Use different colors and icons depending on signal strength ($P9K_WIFI_BARS).
  #
  #   # Wifi colors and icons for different signal strength levels (low to high).
     typeset -g my_wifi_fg=(1 1 1 1 1)                                # <-- change these values
     typeset -g my_wifi_icon=(' with poor signal,' 'with low signal,' ' with average signal,' ' with good signal,' ' with best signal,')     # <-- change these values
  #
